    ...
    <footer className="bg-[#052F33] text-white pt-16 pb-10 text-left">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-14 border-b border-[#0D464B]">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-[#C2D7D9] font-normal leading-relaxed max-w-sm pt-1">
              A private, sacred sanctuary for intuitive clarity and personal empowerment. You don't have to have everything figured out — you just need a place to begin.
            </p>

            <div className="pt-2 text-xs text-[#A8C4C6]">
              <span>No name • No date of birth • 100% Confidential</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-[#C2D7D9]">
              <li>
                <button onClick={() => onNavigate('/#founders')} className="hover:text-white transition-colors cursor-pointer">
                  Our Founders
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('/why-vbh')} className="hover:text-white transition-colors cursor-pointer">
                  Why VBH?
                </button>
              </li>
              <li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#8BA4A6]">
          <div>
            © {new Date().getFullYear()} Visions By Himani. All rights reserved.
          </div>

          <div className="flex items-center gap-4">
            <button onClick={() => onNavigate('/why-vbh')} className="hover:text-white cursor-pointer">
              Privacy Policy
            </button>
            <span>|</span>
            <button onClick={() => onNavigate('/why-vbh')} className="hover:text-white cursor-pointer">
